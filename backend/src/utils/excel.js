...
function generarPlantilla() {
  ...
  const hojaInstrucciones = XLSX.utils.aoa_to_sheet([
    ...
    ['Si dejas tipo_talla en blanco, la talla se crea con tipo "general" (no participa en'],
    ['"Completar tallas de calzado" ni en la guía de tallas de la tienda en línea, así que'],
    ['para calzado es mejor no dejarlo en blanco).'],
    [''],

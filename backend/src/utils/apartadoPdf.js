...
function dibujarComprobante(doc, { apartado, pagadoTotal, montoEsteEvento, whatsappContacto, barcodeBuffer, marca }) {
...
async function generarComprobanteApartado(apartado, pagadoTotal, montoEsteEvento, whatsappContacto) {
  ...
  const dibujar = (doc) =>
    dibujarComprobante(doc, { apartado, pagadoTotal, montoEsteEvento, whatsappContacto, barcodeBuffer, marca });

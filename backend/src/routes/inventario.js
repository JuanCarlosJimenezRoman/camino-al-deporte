...
router.get('/existencias', requireAuth, async (req, res) => {
...
router.get('/bajo-stock', requireAuth, async (req, res) => {
...
router.post('/movimientos', requireAuth, requireRole(...ROLES_INVENTARIO), async (req, res) => {
...
router.get('/movimientos/:varianteId', requireAuth, async (req, res) => {

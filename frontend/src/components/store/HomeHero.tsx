...
//
// Rediseño "deportivo premium": superficie tinta (#0D0D0D) con acentos
// dorados (#F2BA52) — la marca deja de estar en segundo plano. El titular es
// grande y en mayúsculas, el CTA lleva gradiente dorado, y la foto va con un
// halo dorado que la hace flotar sobre el fondo.
export function HomeHero({ productoDestacado }: { productoDestacado: ProductoCatalogo | null }) {
  ...
  return (
    <section className="-mt-6 pb-8 pt-0 sm:mt-0 sm:pb-12 sm:pt-4 lg:pb-14">
      <div className="relative overflow-hidden rounded-[2rem] bg-ink px-6 py-10 text-ink-foreground sm:px-10 sm:py-14 lg:px-14 lg:py-16">
        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-black uppercase leading-[0.95] tracking-tight text-white sm:text-5xl lg:text-6xl">
              Encuentra tu <span className="bg-gradient-to-r from-gold via-gold to-bronze bg-clip-text text-transparent">próximo par.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              {productoDestacado && (
                <Link
                  ...
                  className={`${claseBotonSecundario} border-white/25 text-white hover:border-gold hover:text-gold`}
                >
                  Ver destacado
                </Link>
              )}
          ...
          {imagen && productoDestacado && (
            ...
            >
              ...
              />
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl ring-1 ring-white/10 lg:aspect-square">
              ...
              <div className="mt-3 lg:hidden">
                <p className="text-xs font-semibold text-gold">{productoDestacado.marca?.nombre}</p>
                <p className="line-clamp-2 text-sm font-bold text-white">{productoDestacado.nombre}</p>
              </div>
            </Link>
          )}
        </div>

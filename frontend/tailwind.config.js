  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Marca de la tienda (ver globals.css): tinta/negro base, dorado
        // protagonista y bronce legible para texto.
        ink: {
      ...
      keyframes: {
        ...
        /* Entradas para el rediseño "deportivo premium" de la tienda: reveal
           al hacer scroll (fade-up), escala para overlays/cards, marquee para
           marcas, flotado suave para acentos del hero y un brillo que recorre
           los CTAs dorados. Sin depender de tailwindcss-animate. */
        'fade-up': {
